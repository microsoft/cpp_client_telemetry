...
class IGuestLogManager
{
  public:
    ...
    virtual ACTStatus SetContext(const std::string& name, const std::string& value, CustomerContentKind ccKind) = 0;
    ...
    /// <param name="value">Value of the context property</param>
    /// <param name='ccKind'>Customer content kind</param>
    virtual ACTStatus SetContext(const std::string& name, const char *value, CustomerContentKind ccKind) = 0;
