...
public class EventProperties {
    ...
    private EventPropertiesStorage mStorage = new EventPropertiesStorage();
    ...
    public EventProperties(final EventProperties copy) {
        ...
        mStorage.copyEventPropertiesStorage(copy.mStorage);
    }
    ...
    public boolean setName(final String name) {
        ...
        if (nativeIsEventNameValid(name)) {
    ...
    private native boolean nativeIsTypeValid(String recordType);
    ...
    public boolean setType(final String recordType) {
        if (recordType == null || recordType.trim().isEmpty())
            throw new IllegalArgumentException("recordType is null or empty");

        if (nativeIsTypeValid(recordType)) {
    ...
    {
        setProperty(Constants.COMMONFIELDS_EVENT_LEVEL, level, PiiKind.None, DataCategory.PartC);
    }
    ...
    public void setProperty(final String name, final String value) {
        setProperty(name, new EventProperty(value, PiiKind.None, DataCategory.PartC));
    }
     ...
     */
    public void setProperty(final String name, final String value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final double value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (piiKind == null)
            throw new IllegalArgumentException("piiKind is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final int value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (piiKind == null)
            throw new IllegalArgumentException("piiKind is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final long value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (piiKind == null)
            throw new IllegalArgumentException("piiKind is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final boolean value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (piiKind == null)
            throw new IllegalArgumentException("piiKind is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final Date value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (value == null)
            throw new IllegalArgumentException("value is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final UUID value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
        if (value == null)
            throw new IllegalArgumentException("value is null");
     ...
     * @param category DataCategory of the property, if passed null default DataCategory.PartC is set.
     */
    void setProperty(final String name, final String[] value, PiiKind piiKind, DataCategory category) {
        if (name == null || name.trim().isEmpty())
            throw new IllegalArgumentException("name is null");
     ...
     */
    public Map<String, EventProperty> getProperties(DataCategory category) {
     ...
     *
     * @param category DataCategory of the properties
     * @return Pii Properties bag of the event
     *//*
    public Map<String, Pair<String, PiiKind>> GetPiiProperties(DataCategory category) {
        Map<String, Pair<String, PiiKind>> pIIExtensions = new HashMap<>();
        Map<String, EventProperty> props = (category == DataCategory.PartC) ? mStorage.properties : mStorage.propertiesPartB;
        for(Map.Entry<String, EventProperty> entry : props.entrySet()) {
            String k = entry.getKey();
            EventProperty v = entry.getValue();
            if(v.getPiiKind() != PiiKind.None) {
                pIIExtensions.put(k, new Pair<String, PiiKind>(v.to_String(), v.getPiiKind()));
            }
        }
     ...
     * @return boolean value true if key found or else false
     */
    boolean erase(final String key, DataCategory category) {
