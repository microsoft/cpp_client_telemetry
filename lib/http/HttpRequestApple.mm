...
HttpRequestApple::HttpRequestApple(HttpClient_Apple* parent) :
...
HttpRequestApple::~HttpRequestApple() noexcept
{
    m_parent->Erase(static_cast<IHttpRequest*>(this));
}

void HttpRequestApple::SendAsync(IHttpResponseCallback* callback)
{
    @autoreleasepool
    {
        m_callback = callback;
...
void HttpRequestApple::HandleResponse(NSData* data, NSURLResponse* response, NSError* error)
{
    @autoreleasepool
    {
