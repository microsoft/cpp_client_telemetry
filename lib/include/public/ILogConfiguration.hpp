    ...
    namespace Applications {
        namespace Telemetry {
            ...
            public:
                ...
                virtual char const* GetProperty(char const* key, bool& error = err) const = 0;
                ...
                virtual uint32_t GetIntProperty(char const* key, bool& error = err) const = 0;
                ...
                virtual bool GetBoolProperty(char const* key, bool& error = err) const = 0;
                ...
                virtual void* GetPointerProperty(char const* key, bool& error = err) const = 0;
                ...
                /// <param name="key">A pointer to a character constant that contains the key string.</param>
                /// <param name="value">A boolean that contains the value.</param>
                inline void SetProperty(const char *key, bool value) { SetBoolProperty(key, value); };
                ...
                /// <param name="key">A pointer to a character constant that contains the key string.</param>
                /// <param name="value">A void pointer that points to the value.</param>
                inline void SetProperty(const char *key, void* value) { SetPointerProperty(key, value); };
                ...
                /// <param name="key">A pointer to a character constant that contains the key string.</param>
                /// <param name="value">A uint32_t that contains the value.</param>
                inline void SetProperty(const char *key, uint32_t value) { SetIntProperty(key, value); };
            ...
            public:
                ...
                inline ConfigKey &operator=(const void* value)
                {
                    type = TypePtr;
                    config->SetProperty(key, (void *)value);
                    return (*this);
                }
