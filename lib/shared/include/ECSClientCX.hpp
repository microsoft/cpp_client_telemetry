...
// XXX: unfortunately we have two headers with the same name:
// internal/IEcsClient.hpp
// include/IECSClient.hpp
//
// This is a legacy baggage of the past. Ideally we should rename the internal header to something else
// because IECSClient.hpp is already published as part of public SDK API, so we cannot change that.
//
#include "IECSClient.hpp"
