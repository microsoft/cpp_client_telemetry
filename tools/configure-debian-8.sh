...
# Aria SDK requires gcc-5.x or newer compiler.
...
# Checkout Aria SDK source
# git clone https://msasg.visualstudio.com/DefaultCollection/Shared%20Data/_git/Aria.SDK.Cpp
# git checkout aria-cpp-v2-linux
