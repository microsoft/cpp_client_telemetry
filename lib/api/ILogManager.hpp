...
class ILogManager
{
  public:
    ...
    virtual ILogger* GetLogger(std::string const& tenantToken, ContextFieldsProvider* parentContext, std::string const& source = std::string(), std::string const& experimentationProject = std::string()) = 0;
