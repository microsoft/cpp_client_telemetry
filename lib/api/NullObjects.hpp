...
namespace ARIASDK_NS_BEGIN {
    ...
    public:
        ...
        virtual void ResetTransmitProfiles() override
        {
        }
        ...
        virtual EVTStatus SetContext(const std::string & name, const char * value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        ...
        virtual EVTStatus SetContext(const std::string & name, int8_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, int16_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, int32_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, uint8_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, uint16_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, uint32_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
        virtual EVTStatus SetContext(const std::string & name, uint64_t value, PiiKind piiKind = PiiKind_None) override
        {
            return EVTStatus_OK;
        }
