...
void WinPhoneCPP::MainPage::button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	EventProperties event("NewSdkTest");
	logger->LogEvent("NewSdkTest");
	LogManager::Flush();
}
