...
exhale_args = {
        "containmentFolder": "oneds_docs",
        "rootFileName": "oneds_docs.rst",
...
breathe_projects = {
        "Microsoft C++ Client Telemetry SDK": "doxyoutput/xml",
}
breathe_default_project = "Microsoft C++ Client Telemetry SDK"
