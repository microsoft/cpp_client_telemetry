    ...
    namespace Applications {
        namespace Experimentation {
            namespace AFD {
                ...
                /// </summary>
                class MATSDK_LIBABI IAFDClient
                {
                public:
                    /// <summary>
                    /// Creates a new instance of an AFDClient.
                    /// </summary>
                    static IAFDClient* MATSDK_LIBABI_CDECL CreateInstance();

                    /// <summary>
                    /// Destroys the specified AFDClient instance.
                    /// </summary>
                    static void MATSDK_LIBABI_CDECL DestroyInstance(IAFDClient** ppAFDClient);
