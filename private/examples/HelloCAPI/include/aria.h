...
#define evt_log(handle, evt) evt_log_s(handle, EVT_ARRAY_SIZE(evt), evt)
    ...
    /// <summary>
    /// Pass down SDK header version to SDK library that is needed for late binding version check.
    /// 
    /// TODO: this method provides means of a handshake between library header and a library impl.
    /// It is up to app dev to verify the value returned and make a decision whether some SDK
    /// features are implemented by particular SDK version or not.
    ///
    /// </summary>
