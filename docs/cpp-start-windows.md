...
Visual Studio 2022 and newer may report the legacy .NET Framework 4.0 wrapper project (`net40`) as unsupported. It is only needed by .NET Framework consumers such as `SampleCsNet48`; the VS2022 and VS2026 command-line wrappers skip those projects, and you can unload them in the IDE when building the native SDK.
