@ECHO OFF
set ProjectName=Microsoft.Applications.Telemetry.Windows.static-vc140-MD
set NuGetFolder=%CD%
cd ../..
set SolutionDir=%CD%
...
md lib\native
robocopy %NativeSDKFolder%\lib\win32-lib-vs2015-md %NuGetFolder%\lib\native\win32-lib-vs2015-md /E
