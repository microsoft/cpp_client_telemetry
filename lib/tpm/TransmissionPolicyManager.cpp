...
namespace ARIASDK_NS_BEGIN {
    ...
    TransmissionPolicyManager::TransmissionPolicyManager(ITelemetrySystem& system, IWorkerThread& workerThread, IBandwidthController* bandwidthController)
        : m_lock(),
        m_system(system),
    ...
    void TransmissionPolicyManager::scheduleUpload(int delayInMs, EventLatency latency, bool force)
    {
        ...
        if (!m_isUploadScheduled.exchange(true))
        {
            ...
            m_scheduledUpload = PAL::scheduleOnWorkerThread(&m_workerThread, delayInMs, this, &TransmissionPolicyManager::uploadAsync, latency);
        }
    }
