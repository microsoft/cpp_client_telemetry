...
#define GETUPTIME() PAL::getUtcSystemTimeMs()
...
namespace Microsoft {
    namespace Applications {
        namespace Telemetry {
            ...
            /// <summary>DebugEventSource is internal object that sends SDK debug events to DebugEventListener</summary>
...
#ifndef __cplusplus_cli
                /// <summary>Last debug event sequence number.</summary>
                std::atomic<int64_t> seq;
#else
                // sequence number is not atomic on .NET SDK!
                int64_t seq;
#endif
            public:
