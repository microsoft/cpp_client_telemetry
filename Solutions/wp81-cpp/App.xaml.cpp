...
LogConfiguration ^configuration = ref new LogConfiguration();

Platform::String^ cTenantToken = "6d084bbf6a9644ef83f40a77c9e34580-c2d379e0-4408-4325-9b4d-2a7d78131e14-7322";
...
App::App()
{
    ...
    LogManager::Initialize(cTenantToken, configuration);
...
void App::OnLaunched(LaunchActivatedEventArgs^ e)
{
	...
	if (rootFrame == nullptr)
	{
        ...
        rootFrame->Language = "en"; // Windows::Globalization::ApplicationLanguages::Languages->GetAt(0);
