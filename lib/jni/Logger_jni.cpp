...
extern "C"
{
        ...
        jobjectArray jEventPropertyValue)
    {
        ...
        jint* aggregateTypeKeys = env->GetIntArrayElements(jAggregateTypeKeys, nullptr);
        jdouble* aggregateDoubleValues = env->GetDoubleArrayElements(jAggregateDoubleValues, nullptr);
        ...
        jlong* bucketsLongKeys = env->GetLongArrayElements(jBucketsLongKeys, nullptr);
        jlong* bucketsLongValues = env->GetLongArrayElements(jBucketsLongValues, nullptr);
