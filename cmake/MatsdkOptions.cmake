...
matsdk_bool_option(MATSDK_LINK_STATIC_DEPENDS LINK_STATIC_DEPENDS
  "Link dependencies statically where supported" ON)
...
option(MATSDK_MINIMAL_SQLITE
  "Deprecated compatibility switch for MATSDK_SQLITE_PROVIDER=MINIMAL" OFF)
option(MATSDK_BUNDLE_VENDORED_DEPS
  "Build the SDK's vendored SQLite and symbol-prefixed zlib" OFF)
...
if(MATSDK_SQLITE_PROVIDER_RESOLVED STREQUAL "AUTO")
  ...
  elseif(MATSDK_MINIMAL_SQLITE)
    set(MATSDK_SQLITE_PROVIDER_RESOLVED MINIMAL)
  elseif(MATSDK_BUNDLE_VENDORED_DEPS
      OR (NOT MATSDK_USE_VCPKG_DEPS
...
elseif(MATSDK_MINIMAL_SQLITE
    AND NOT MATSDK_SQLITE_PROVIDER_RESOLVED STREQUAL "MINIMAL")
  message(FATAL_ERROR
    "MATSDK_MINIMAL_SQLITE=ON conflicts with "
