...
namespace MAT_NS_BEGIN
{
    ...
    {
#if defined(HAVE_LEAKY_GLOBALS)
        static Leaky<ILogConfiguration> leakyDefaultRuntimeConfig;
        ILogConfiguration& defaultRuntimeConfig = *leakyDefaultRuntimeConfig;
#else
        static ILogConfiguration defaultRuntimeConfig;
#endif
        ...
        if (!initialized)
        {
            defaultRuntimeConfig = ILogConfiguration{
