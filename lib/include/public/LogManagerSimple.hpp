...
#ifndef ARIA_LogManagerSimple_HPP
#define ARIA_LogManagerSimple_HPP
...
namespace Microsoft {
    namespace Applications {
        namespace Events  {
            ...
            /// </summary>
            class ARIASDK_LIBABI LogManagerSimple
            {
            public:
                /// <summary>
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL Start(
#ifdef ANDROID
                    JNIEnv *env,
                    jclass contextClass,
                ...
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL Teardown();

                /// <summary>
                /// Try to send any pending telemetry events in memory or on disk.
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL UploadNow();
                ...
                /// time consuming.
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL Flush();
                ...
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL PauseTransmission();

                /// <summary>
                /// Resumes the transmission of events to data collector.
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL ResumeTransmission();
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetTransmitProfile(TransmitProfile profile);
#ifndef ANDROID
                /// <summary>
                ...
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL ResetTransmitProfiles();
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, const std::string& value, PiiKind piiKind = PiiKind_None);
                ...
                /// <param name="value">Value of the context property</param>
                /// <param name='piiKind'>PIIKind of the context with PiiKind_None as the default</param>
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, const char *value, PiiKind piiKind = PiiKind_None) { const std::string val(value); return SetContext(name, val, piiKind); };
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, double value, PiiKind piiKind = PiiKind_None);
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, int64_t value, PiiKind piiKind = PiiKind_None);
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, int8_t  value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, int16_t value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, int32_t value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, uint8_t  value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, uint16_t value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, uint32_t value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static inline EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, uint64_t value, PiiKind piiKind = PiiKind_None) { return SetContext(name, (int64_t)value, piiKind); }
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, bool value, PiiKind piiKind = PiiKind_None);
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, time_ticks_t value, PiiKind piiKind = PiiKind_None);
                ...
                static EVTStatus ARIASDK_LIBABI_CDECL SetContext(const std::string& name, GUID_t value, PiiKind piiKind = PiiKind_None);
                ...
                /// Add Debug callback
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL AddEventListener(DebugEventType type, DebugEventListener &listener);

                /// <summary>
                /// Remove Debug callback
                /// </summary>
                static EVTStatus ARIASDK_LIBABI_CDECL RemoveEventListener(DebugEventType type, DebugEventListener &listener);
            ...
            protected:
                ...
                /// <summary>
                /// LogManagerSimple constructor
                /// </summary>
                LogManagerSimple();

                /// <summary>
                /// LogManagerSimple copy constructor
                /// </summary>
                LogManagerSimple(const LogManagerSimple&);

                /// <summary>
                /// [not implemented] LogManagerSimple assignment operator
                /// </summary>
                LogManagerSimple& operator=(const LogManagerSimple&);

                /// <summary>
                /// LogManagerSimple destructor
                /// </summary>
                virtual ~LogManagerSimple() {};

                /// <summary>
                /// Debug routine that validates if LogManagerSimple has been initialized. May trigger a warning message if not.
                /// </summary>
